...
export default function RecoverPassword() {
    return (
        <div className='recoverAuth'>
            <div className='bg-overlay'>
            </div>

            <div className='containrec'><div className='container'>
                    ...
                    <div className="col-md-8 col-lg-6 col-xl-4">
                        ...
                        >
                            ...
                            <CardBody className='p-4' >
                                ...
                                <div className="font14 alert alert-warning alert-dismissible">
                                    <button
                                        type="button"
                                        className="btn-close"
